<?php
include '/mnt/config/dbKeys/log_read.php';
...
function db__getData($conn,$table,$clmnName="",$value="",$clmnName2="",$value2="", $more = "")
{
	...
	if($more != "") $sql = "SELECT * FROM $table $more";
    elseif($clmnName=="") $sql = "SELECT * FROM $table";
...
//	return curl__post($url, array("ak" => $GLOBALS['ggj_ak'], "userID" => $GLOBALS['ggj_userID'], "memobirdID" => $GLOBALS['ggj_memobirdID'], "printcontent" => "T:".base64_encode($body)."", "timestamp" => "".date('Y-m-d H:i:s')."", "useridentifying" => "123333"));

    require 'memobird.php';
    $m = new memobird($GLOBALS['ggj_ak']);
    return $m->printPaper( "T:".base64_encode(iconv("UTF-8","gbk//TRANSLIT",$body))."", $GLOBALS['ggj_memobirdID'], $GLOBALS['ggj_userID']);
